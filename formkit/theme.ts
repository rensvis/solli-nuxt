...
export default {
  ...
  global: {
    fieldset: "max-w-md border border-neutral-400 rounded px-2 pb-1",
    help: "text-xs text-neutral-500",
    inner:
      "formkit-disabled:bg-neutral-200 formkit-disabled:cursor-not-allowed formkit-disabled:pointer-events-none",
    input:
    ...
    prefixIcon:
      "w-10 flex self-stretch grow-0 shrink-0 rounded-tl rounded-bl border-r border-neutral-400 bg-white bg-gradient-to-b from-transparent to-neutral-200 [&>svg]:w-full [&>svg]:max-w-[1em] [&>svg]:max-h-[1em] [&>svg]:m-auto",
    suffixIcon:
  ...
  "family:box": {
    decorator:
      "block relative h-5 w-5 mr-2 rounded bg-white bg-gradient-to-b from-transparent to-neutral-200 ring-1 ring-neutral-400 peer-checked:ring-blue-500 text-transparent peer-checked:text-blue-500",
    decoratorIcon:
      "flex p-[3px] w-full h-full absolute top-1/2 left-1/2 -tranneutral-y-1/2 -tranneutral-x-1/2",
    help: "mb-2 mt-1.5",
    input:
      "absolute w-0 h-0 overflow-hidden opacity-0 pointer-events-none peer",
    inner: "$remove:formkit-disabled:bg-neutral-200",
    label: "$reset text-sm text-neutral-700 mt-1 select-none",
    wrapper: "flex items-center mb-1",
  },
  "family:button": {
    input:
      "$reset inline-flex items-center bg-blue-600 text-white text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-neutral-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin",
    wrapper: "mb-1",
  ...
  "family:dropdown": {
    ...
    emptyMessageInner:
      "flex items-center justify-center text-sm p-2 text-center w-full text-neutral-500 [&>span]:mr-3 [&>span]:ml-0",
    inner:
      "max-w-md relative flex ring-1 ring-neutral-400 focus-within:ring-blue-500 focus-within:ring-2 rounded mb-1 formkit-disabled:focus-within:ring-neutral-400 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-blue-500",
    input: "w-full px-3 py-2",
    listbox: "bg-white drop-shadow-lg rounded overflow-hidden",
    listboxButton: "flex w-12 self-stretch justify-center mx-auto",
    listitem:
      'pl-7 relative hover:bg-neutral-300 data-[is-active="true"]:bg-neutral-300 data-[is-active="true"]:aria-selected:bg-blue-600 aria-selected:bg-blue-600 aria-selected:text-white',
    loaderIcon: "ml-auto",
    loadMoreInner:
      "flex items-center justify-center text-sm p-2 text-center w-full text-blue-500 formkit-loading:text-neutral-500 cursor-pointer [&>span]:mr-3 [&>span]:ml-0",
    option: "p-2.5",
    optionLoading: "text-neutral-500",
    placeholder: "p-2.5 text-neutral-400",
    selector: "flex w-full justify-between items-center [&u]",
    selectedIcon: "block absolute top-1/2 left-2 w-3 -tranneutral-y-1/2",
    selectIcon: "flex box-content w-4 px-2 self-stretch grow-0 shrink-0",
  },
  "family:text": {
    inner:
      "flex items-center max-w-md ring-1 ring-neutral-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1",
    input:
      "w-full px-3 py-2 border-none text-base text-neutral-700 placeholder-neutral-400",
  },
  "family:date": {
    inner:
      "flex items-center max-w-md ring-1 ring-neutral-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1",
    input:
      "w-full px-3 py-2 border-none text-neutral-700 placeholder-neutral-400",
  },
  ...
  file: {
    ...
    noFiles: "flex w-full items-center px-3 py-2 text-neutral-400",
  ...
  select: {
    inner:
      "flex relative max-w-md items-center rounded mb-1 ring-1 ring-neutral-400 focus-within:ring-blue-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-blue-500",
    input:
      'w-full pl-3 pr-8 py-2 border-none text-base text-neutral-700 placeholder-neutral-400 formkit-multiple:p-0 data-[placeholder="true"]:text-neutral-400 formkit-multiple:data-[placeholder="true"]:text-inherit',
    selectIcon:
  ...
  textarea: {
    inner:
      "flex max-w-md rounded mb-1 ring-1 ring-neutral-400 focus-within:ring-blue-500 [&>label:first-child]:focus-within:text-blue-500",
    input:
      "block w-full h-32 px-3 py-3 border-none text-base text-neutral-700 placeholder-neutral-400 focus:shadow-outline",
  },
  ...
  autocomplete: {
    ...
    selection:
      "static flex left-0 top-0 right-0 bottom-0 mt-0 mb-2 rounded bg-neutral-100",
  },
  datepicker: {
    inner: "relative",
    panelWrapper:
    ...
    overlayPlaceholder: "text-neutral-400",
    ...
    `,
    timeInput:
      "w-full border-2 border-neutral-300 rounded-md p-2 my-[2em] focus-visible:outline-blue-500",
    daysHeader: "flex items-center justify-center",
    prev: "mr-auto px-3 py-1 hover:bg-neutral-100 hover:rounded-lg col-start-1 col-end-1",
    prevLabel: "hidden",
    ...
    yearButton:
      "appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-blue-500",
    next: "ml-auto px-3 py-1 hover:bg-neutral-100 hover:rounded col-start-3 col-end-3",
    nextLabel: "hidden",
  ...
  repeater: {
    ...
    fieldset: "py-4 px-5",
    help: "mb-2 mt-1.5",
    item: "flex w-full mb-1 rounded border border-neutral-200",
  ...
  slider: {
    ...
    trackWrapper: "px-[2px] rounded-full bg-neutral-200",
    ...
    mark: 'absolute top-1/2 w-[3px] h-[3px] rounded-full -tranneutral-x-1/2 -tranneutral-y-1/2 bg-neutral-400 data-[active="true"]:bg-white',
    markLabel:
      "absolute top-[calc(100%+0.5em)] left-1/2 text-neutral-400 text-[0.66em] -tranneutral-x-1/2",
    handles: "m-0 p-0 list-none",
    handle:
      'group w-4 h-4 rounded-full bg-white absolute top-1/2 left-0 z-[2] -tranneutral-x-1/2 -tranneutral-y-1/2 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.8)] focus-visible:outline-0 focus-visible:ring-2 ring-blue-500 data-[is-target="true"]:z-[3]',
    tooltip:
      'absolute bottom-full left-1/2 -tranneutral-x-1/2 -tranneutral-y-[4px] bg-blue-500 text-white py-1 px-2 text-xs leading-none whitespace-nowrap rounded-sm opacity-0 pointer-events-none transition-opacity after:content-[""] after:absolute after:top-full after:left-1/2 after:-tranneutral-x-1/2 after:-tranneutral-y-[1px] after:border-4 after:border-transparent after:border-t-blue-500 group-hover:opacity-100 group-focus-visible:opacity-100 group-data-[show-tooltip="true"]:opacity-100',
    linkedValues: "flex items-start justify-between",
    minValue:
      'grow max-w-[45%] mb-0 relative [&_.formkit-inner::after]:content-[""] [&_.formkit-inner::after]:absolute [&_.formkit-inner::after]:left-[105%] [&_.formkit-inner::after]:-tranneutral-y-1/2 [&_.formkit-inner::after]:w-[10%] [&_.formkit-inner::after]:h-[1px] [&_.formkit-inner::after]:bg-neutral-500',
    maxValue: "grow max-w-[45%] mb-0 relative",
    chart:
      "relative z-[2] mb-2 flex justify-between items-center w-full aspect-[3/1]",
    chartBar:
      'absolute bottom-0 h-full bg-neutral-400 opacity-[.66] data-[active="false"]:opacity-[.25]',
  },
  taglist: {
  ...
  toggle: {
    ...
    innerLabel:
      "text-[10px] font-bold absolute left-full top-1/2 -tranneutral-x-full -tranneutral-y-1/2 px-1",
    thumb:
      "relative left-0 aspect-square rounded-full transition-all w-5 bg-neutral-100",
    track:
      "p-0.5 min-w-[3em] relative rounded-full transition-all bg-neutral-400 peer-checked:bg-blue-500 peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-tranneutral-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:tranneutral-x-0",
  ...
  transferlist: {
    ...
    help: "pb-2",
    transferlist:
      "sm:w-3/5 shadow-md flex flex-col min-h-[350px] max-h-[350px] border rounded overflow-hidden select-none bg-neutral-50",
    transferlistHeader:
      "flex bg-neutral-100 justify-between items-center border-b p-3",
    transferlistHeaderItemCount: "ml-auto text-sm",
    transferlistListItems:
      "list-none bg-neutral-50 h-full sm:max-w-xs overflow-x-hidden overflow-y-auto",
    transferlistListItem:
      "pl-8 relative aria-selected:bg-blue-600 aria-selected:data-[is-active=true]:bg-blue-600 aria-selected:text-white aria-selected:data-[is-active=true]:text-white first:-mt-px first:border-t py-2 px-3 flex relative border-b bg-white data-[is-active=true]:text-blue-500 data-[is-active=true]:bg-neutral-100 cursor-pointer group-data-[is-max=true]:cursor-not-allowed items-center",
    transferlistOption: "text-sm",
    transferControls:
      "flex sm:flex-col justify-center mx-auto my-2 sm:mx-2 sm:my-auto border rounded",
    transferlistButton:
      "text-sm disabled:cursor-not-allowed disabled:bg-neutral-200 disabled:opacity-50 first:rounded-l last:rounded-r sm:first:rounded-t sm:last:rounded-b appearance-none p-2 m-0 cursor-pointer h-10 border-none rounded-none bg-neutral-50 hover:outline disabled:hover:outline-none hover:outline-1 hover:outline-black hover:text-blue-500 disabled:hover:text-current hover:z-10",
    sourceEmptyMessage:
      "appearance-none border-none w-full p-0 m-0 text-center text-neutral-500 italic",
